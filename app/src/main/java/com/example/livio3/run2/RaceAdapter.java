...
public class RaceAdapter extends ArrayAdapter<Race> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        int blue= context.getResources().getColor(android.R.color.holo_blue_dark);
        ...
        if((position)%2==0) {
            ...
            tvDistance.setTextColor(blue);
            tvLocality.setTextColor(blue);
        ...
        }else
        {
            ...
            tvDistance.setTextColor(white);
            tvLocality.setTextColor(white);
